...
export function fontFit(font, weight, makeCanvas) {
...
export function fitFontSize(cellW, cellH, font, weight, makeCanvas) {
...
export function rowsForAspect(cols, mediaW, mediaH, cellAspect) {
